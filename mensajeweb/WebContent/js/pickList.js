(function ($) {
   ...
   $.fn.pickList = function (options) {
      ...
      this.controll = function () {
         ...
         pickThis.find(".pAdd").on('click', function (event) {
         ...
         pickThis.find(".pAddAll").on('click', function (event) {
        	event.preventDefault();
         ...
         pickThis.find(".pRemove").on('click', function (event) {
        	event.preventDefault();
         ...
         pickThis.find(".pRemoveAll").on('click', function (event) {
        	event.preventDefault();
