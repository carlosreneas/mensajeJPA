          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
             <div class="btn-group mr-2">
                <a href="contactoedit.jsp" class="btn btn-sm btn-outline-primary">Nuevo</a>
          ...
          <jsp:useBean id="cDao" class="model.ContactoDao" scope="request">
            ...
            <table class="table table-striped table-sm">
              ...
              <tbody>
				...
				<td><a href="ContactoController?id=<c:out value="${contacto.id}"/>&ed=1"><span data-feather="edit"></span></a> <a href="ContactoController?id=<c:out value="${contacto.id}"/>&ed=2"><span data-feather="trash"></span></a></td>             
				</tr>
				</c:forEach>
